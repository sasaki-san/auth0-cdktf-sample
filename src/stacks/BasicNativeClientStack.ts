...
class BasicNativeClientStack extends BaseAuth0TerraformStack {
...
export const CreateBasicNativeClientStack = (app: App) => {
  new BasicNativeClientStack(app, "basic-native-client");
}